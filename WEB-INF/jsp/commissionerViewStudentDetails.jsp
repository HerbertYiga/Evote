	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="active"><a href="commissionerPanel"><i class="fa fa-home"></i>Dashboard</a></li>
				<li class="sub open"><a href="javascript:;"> <i
						class="fa fa-eye"></i> Verified Students
			...
			<div class="templatemo-content">
				...
				<div class="row">
												...
												<div id="circle-shape-example">
													...
													<img
														src="<c:url value='/resources/image/${suspect.imageLink}'/>"
														alt="No photo"
														class="curve" height="80" weight="80">
												</div>
												...
												<div class="col-sm-7 col-xs-6 ">${student.names} </div>
												<div class="clearfix"></div>
												<div class="bot-border"></div>

												<div class="col-sm-5 col-xs-6 tital "><b>Hall:</b></div>
												<div class="col-sm-7">${student.hall}</div>
												<div class="clearfix"></div>
												<div class="bot-border"></div>

												<div class="col-sm-5 col-xs-6 tital "><b>Sex:</b></div>
												<div class="col-sm-7">${student.sex}</div>
												<div class="clearfix"></div>
												<div class="bot-border"></div>

												<div class="col-sm-5 col-xs-6 tital "><b>Program Type:</b></div>
												<div class="col-sm-7">${student.programType}</div>

												<div class="clearfix"></div>
												<div class="bot-border"></div>

												<div class="col-sm-5 col-xs-6 tital "><b>Coordinator:</b></div>
												<div class="col-sm-7">${student.coordinator}</div>

												<div class="clearfix"></div>
												<div class="bot-border"></div>

												<div class="col-sm-5 col-xs-6 tital "><b>Citizenship:</b></div>
												<div class="col-sm-7">${student.citizenship}</div>

												<div class="clearfix"></div>
												<div class="bot-border"></div>

												<div class="col-sm-5 col-xs-6 tital "><b>Residence Type:</b></div>
												<div class="col-sm-7">${student.residenceType} </div>
					...
					<form:form class='form-center' action="commissionerGenerateVotingToken"
						commandName="confirm">
