					...
					<ul class="templatemo-submenu">
						...
						<li><a href="javascript:;" data-toggle="modal"
							data-target="#uploadRegisterImageModal"><i
								class="fa fa-upload"></i> Upload Images </a></li>


						<li><a href="./exportVotersImageNames" data-toggle="modal"
						...
						<li><a href="javascript:;" data-toggle="modal"
							data-target="#uploadRegisterModal"><i class="fa fa-upload"></i>
								Upload Register</a></li>
										...
										<li><a href="./exportVotersRegister" data-toggle="modal"
							><i class="fa fa-download"></i>
									Download Register</a></li>
								...
								<div class="col-md-12">
									...
									<div class="table-responsive">
										...
										<h5 class="margin-bottom-15" style="color: red">
											<b>${uploadImageErrorUser}</b>
										</h5>
										
										<h5 class="margin-bottom-15" style="color: red">
											<b>${uploadErrorVotersCsv}</b>
										</h5>
															...
															<td>
																...
																<div class="btn-group">
																	...
																	<ul class="dropdown-menu" role="menu">
																		<li><a
																			href="<c:url value="/userViewingVoter/${details.studentNo}"/>">Details</a></li>

																		<li><a
																			href="<c:url value="/userEditingVoter/${details.studentNo}"/>">Edit</a></li>
