			...
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="javascript:;"> <i
					...
					<ul class="templatemo-submenu">
						...
						<li><a href="userViewRegisteredCandidate" class="fa fa-edit">
		...
		<div class="templatemo-content-wrapper">
			<div class="templatemo-content">
				<ol class="breadcrumb">
					...
					<li><a href="userViewRegisteredCandidate">Registered
							Candidates</a></li>
					<li class="active">Voters Register</li>
						...
						<div class="templatemo-alerts">
							<div class="row">
								<div class="col-md-12">
									...
									<!-- list oxf users  -->
									<div class="col-md-10 col-sm-10 margin-bottom-30">
											...
											<div class="panel-body">
												...
												<div id="circle-shape-example">
													<img
														...
														class="curve" height="70" weight="70">
												</div>
												...
												<div class="col-sm-7 col-xs-6 ">${candidate.candidateFirstName} &nbsp;&nbsp;${candidate.candidateSecondName}</div>
												<div class="clearfix"></div>
												<div class="bot-border"></div>

												<div class="col-sm-5 col-xs-6 tital ">Sex:</div>
												<div class="col-sm-7">${candidate.sex}</div>
												<div class="clearfix"></div>
												<div class="bot-border"></div>
												...
												<div class="col-sm-5 col-xs-6 tital ">Date Of
													Joining:</div>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<form id="" action="userSaveStudentCsv" method="POST"
								class="form-horizontal" commandName="adduser" enctype="multipart/form-data">
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-lg-7">
											...
											<input type="file" name="fcsvFile" id="fileToUpload"
												/>
										</div>
