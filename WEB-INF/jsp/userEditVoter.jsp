	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="javascript:;"> <i
						class="fa fa-edit"></i> <b style="color: green">Update
							Image</b>
						<div class="pull-right">
							<span class="caret"></span>
						</div>
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h3 class="panel-title">
									<span class="fa fa-edit"></span> <b>Edit Voter Details </b>
								</h3>
							</div>
							<div class="panel-body">
								<div class="row">

									<form id="" action="userUpdateVoterDetails" method="POST"
										class="form-horizontal" 
										name="myform" onsubmit="">
										<fieldset>
											<div class="form-group">
												...
												<div class="col-lg-10">
													<input name="names" class="form-control"
														placeholder="NAMES" id="one" type="text" value="${student.names}"/>
												
												<input name="studentNo" class="form-control"
														placeholder="NAMES" id="one" type="hidden" value="${student.studentNo}"/>
											...
											<div class="form-group">
												...
												<div class="col-lg-10">
													<select name="faculty" class="form-control">
														...
														<option
															value="FACULTY OF SPECIAL NEEDS AND REHABILITATION">FACULTY
